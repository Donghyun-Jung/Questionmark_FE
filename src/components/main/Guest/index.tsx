    ...
    <>
      ...
      <Styled.Root>
        ...
        <Responsive device="desktop">
          <Styled.SubTitle>
            <div>DUEL 에서 학습 방향성을 제공받고 공유하며 성장해보세요.</div>
          </Styled.SubTitle>
        </Responsive>

        <Responsive device="mobile">
          <Styled.SubTitle>
            <div>DUEL 에서 학습 방향성을</div>
            <div>제공받고 공유하며 성장해보세요.</div>
          </Styled.SubTitle>
        </Responsive>

        <Styled.ButtonContainer onClick={() => router.push(DUEL_LINKS.verify())}>
          <Button css={Styled.ButtonStyles}>Get Started</Button>
        </Styled.ButtonContainer>

        <SectionStyled.FeatureSection>
          <SectionStyled.HardWareContainer>
            <SectionStyled.Image src="/assets/images/landing1.png" alt="DUEL" />
          </SectionStyled.HardWareContainer>
        </SectionStyled.FeatureSection>
        ...
        <SectionStyled.FeatureSection>
          <SectionStyled.SectionTitle>이 모든것을 DUEL 에서</SectionStyled.SectionTitle>
          <Styled.ButtonContainer>
            <Button css={Styled.StartButtonStyles} onClick={() => router.push(DUEL_LINKS.verify())}>
              시작하기
            </Button>
          </Styled.ButtonContainer>
        </SectionStyled.FeatureSection>
